...
public class AdventDay6Part2 {
    public static void main(String[] args) {
        ...
        ArrayList<String> loopPositions = new ArrayList<>();
        ...
        for (String loopPosition : loopPositions) {
            ...
            newGrid = new String[rows][columns];
            for (int r = 0; r < grid.length; r++) {
                for (int c = 0; c < grid[0].length; c++) {
                    newGrid[r][c] = grid[r][c];
                }
            ...
            int[] oInt = new int[2];
            oInt[0] = Integer.parseInt(obstacle[0]);
            oInt[1] = Integer.parseInt(obstacle[1]);
            newGrid[oInt[0]][oInt[1]] = "#";
            ArrayList<String> path = traverseMap(newGrid);
            if (path.contains("yes"))
                loopsCreated++;
        }
        System.out.println(loopsCreated);
    }
